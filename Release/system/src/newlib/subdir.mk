...
system/src/newlib/%.o: ../system/src/newlib/%.cpp system/src/newlib/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: GNU Arm Cross C++ Compiler'
	arm-none-eabi-g++ -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra -g -DNDEBUG -DSTM32F401xE -DHSE_VALUE=8000000 -I"../include" -I"C:\Users\hp\eclipse-workspace2\Lab5_KeypadControl_7Seg\Rcc" -I"C:\Users\hp\eclipse-workspace2\Lab5_KeypadControl_7Seg\Gpio" -I"C:\Users\hp\eclipse-workspace2\Lab5_KeypadControl_7Seg\Lib" -I"C:\Users\hp\eclipse-workspace2\Lab5_KeypadControl_7Seg\Keypad" -I"../system/include" -I"../system/include/cmsis" -std=gnu++11 -fabi-version=0 -fno-exceptions -fno-rtti -fno-use-cxa-atexit -fno-threadsafe-statics -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
